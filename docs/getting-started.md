...
The accepted onboarding milestone will add an explicit complete-file
replacement after selected existing guidance has been represented in canonical
rules and the complete replacement remains visible in the current render plan.
It will not silently merge or overwrite foreign instructions.
