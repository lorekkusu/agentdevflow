...
| --- | --- | --- | --- |
| Minimum Node.js | Node.js 22 | Node.js 20 is end-of-life; 22 and 24 are supported LTS lines as of 2026-07-13. Rulesync 9.6.3 also requires Node.js 22 or newer. | Before the first public release, using the then-current support schedule and user evidence. |
...
The Node.js support status is based on the [official Node.js release table](https://nodejs.org/en/about/previous-releases). The Rulesync requirement is pinned and reproduced in the Gate 1 evidence rather than treated as a product-wide dependency decision.
